...
builder.Services.AddDbContext<DataContext>(options => options.UseSqlServer(@"Server=DESKTOP-J9JUD4H\SQLEXPRESS;Database=Trips3;TrustServerCertificate=True;Trusted_Connection=True"));
